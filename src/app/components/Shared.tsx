...
export function Footer() {
  return (
    <footer className="flex flex-col-reverse md:flex-row justify-between items-start md:items-end gap-12 px-6 md:px-12 lg:px-[70px] mt-24 md:mt-32 lg:mt-[120px] pb-16 lg:pb-[65px] font-['Poppins',sans-serif] w-full">
      {/* Built with */}
      <div className="flex flex-col gap-1 md:gap-2 w-full md:w-auto items-center md:items-start text-center md:text-left">
        <h3
      ...
      {/* Social links */}
      <div className="flex flex-col md:flex-row gap-4 md:gap-8 w-full md:w-auto items-start md:items-end">
        <a
